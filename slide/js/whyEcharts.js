require.config({
    paths:{ 
        ...
        'echarts/chart/scatter': 'js/echarts-map',
        'echarts/chart/k': 'js/echarts-map',
        'echarts/chart/pie': 'js/echarts-map',
        'echarts/chart/radar': 'js/echarts-map',
        'echarts/chart/map': 'js/echarts-map',
        'echarts/chart/force': 'js/echarts-map',
        'echarts/chart/chord': 'js/echarts-map',
        webkitDep : 'data/webkit-dep'
    }
});
...
var optionMap = {
    'calculable1' : {
        ...
        toolbox: {
			...
			featureTitle:{
				mark : 'Turn on Mark',
				markUndo : 'Delete the Latest Mark',
				markClear : 'Clear All Mark',
				dataZoom : 'Zoom',
				dataZoomReset : 'Zoom Back',
				dataView : 'data View',
    ...
    dataZoom1 : {
        tooltip : {
            ...
            formatter: function(params) {
                var res = params[0][1];
                res += '<br/>' + params[0][0];
                res += '<br/>  Opening : ' + params[0][2][0] + '  Highest : ' + params[0][2][3];
                res += '<br/>  Close : ' + params[0][2][1] + '  Lowest : ' + params[0][2][2];
                res += '<br/>' + params[1][0];
                res += ' : ' + params[1][2];
                return res;
            }
    ...
    mix2 : {
        ...
        calculable : true,
        legend: {
            data:['Direct access','邮件营销','联盟广告','视频广告','搜索引擎','百度','谷歌','必应','其他']
        },
        xAxis : [
            {
                type : 'category',
