 ...
 * @type {Array}
 */
fish.urls = [{"bottom-bar":"fish/img/bottom-bar.png"},{"number-black":"fish/img/number-black.png"},
 ...
 */
fish.audio = {"music_1":"fish/music/music_1.ogg","bgm_fire":"fish/sound/bgm_fire.ogg","bgm_box":"fish/sound/bgm_box.ogg","bgm_coin_01":"fish/sound/bgm_coin_01.ogg"};

fish.userAgent = navigator.userAgent.toString();
/***
 * 金币声音是否播放完毕
 * @type {boolean}
 */
 ...
 * @type {Array}
 */
fish.cannon_config = [74,74,76,76,83,85,90,94];
/**
 * 鱼的数组
 * @type {Array}
 */
 ...
 * @type {Array}
 */
fish.bullets_config = [{w:24,h:26},{w:24,h:26},{w:25,h:29},{w:27,h:31},{w:29,h:33},{w:30,h:34},{w:31,h:35},{w:32,h:38},{w:30,h:44}];
/**
 * 不同捕鱼网规格配置
 * @type {Array}
 */
fish.web_config = [{w:116,h:118},{w:116,h:118},{w:137,h:142},{w:156,h:162},{w:180,h:174},{w:163,h:155},{w:191,h:181},{w:242,h:244}];
/**
 * 是否可以放网捕鱼
 * @type {boolean}
 */
