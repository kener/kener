...
function AdaptiveSelect(objSelectBox, iMaxRow, iSelectWidth, iMonitorInterval){
	...
	this.awWidth = (typeof(iSelectWidth) != 'number' || iSelectWidth < 0) ? (this._originalSelect.style.width).slice(0,-2)-0 : iSelectWidth; 	//选项宽度
	...
	this._originalSelect.style.display = 'none';		//IE6中当同时设置visibility和display时visibility优先
